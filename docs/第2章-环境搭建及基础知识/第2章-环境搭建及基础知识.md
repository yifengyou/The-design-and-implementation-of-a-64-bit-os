...
- [第2章-环境搭建及基础知识](#第2章-环境搭建及基础知识)
	- [bochs环境搭建](#bochs环境搭建)
		...
		- [DIY-从Github下载源码编译安装](#diy-从github下载源码编译安装)
...
4. 本仓库运行环境位Ubuntu16 64位，与书中CentOS不同

### onkey.sh 一键安装

本仓库bochs目录下提供源码包以及相关一键执行脚本

			bochs-2.6.9.tar.bz2  distract.sh

执行distract.sh进行解压，切换到解压文件夹下执行onekey.sh即可完成编译安装

![1528172293661.png](image/1528172293661.png)

PS:如果有软件包依赖问题，自行搜索相应包安装即可。
